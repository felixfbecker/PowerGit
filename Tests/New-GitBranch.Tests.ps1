...
Describe New-GitBranch {
    Describe 'when creating a new unique branch' {
        Clear-Error
    ...
    Describe 'when trying to create an existing branch name' {
        It 'should write an error' {
            ...
            New-GitBranch -RepoRoot $repo -Name $branchName -ErrorVariable newBranchError -ErrorAction SilentlyContinue

            $newBranchError | Should -Match 'already exists'
            Test-GitBranch -RepoRoot $repo -Name $branchName | Should -BeTrue
        }
    }
    ...
    Describe 'when passing a start point that is not head' {
        Clear-Error
    ...
    Describe 'when passing an invalid start point' {
        Clear-Error
